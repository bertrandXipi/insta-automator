...
export const STRATEGY_POSTS: Post[] = [
  ...
  // ==================== MAI 2026 - FIN DE MOIS (8 posts, 2/jour 28-31 mai) ====================
  {
    ...
    caption: "La salade niçoise, revisitée avec notre Filet de Thon Germon au naturel et laurier bio. Des haricots verts croquants, des œufs mollets, quelques olives de Nice et de belles miettes de thon fondantes. Le printemps dans l’assiette, généreux et sans chichi. 🥗🫒\n\nUne recette qui sent bon le Sud et le large. Prête en 15 minutes, parfaite pour ces longues soirées de mai.\n\n🛒 jeandeluz.com/products/filet-de-thon-germon-au-naturel",
    hashtags: ["#ConserverieJeandeLuz", "#ThonGermon", "#SaladeNicoise", "#RecettePrintemps", "#SaintJeandeLuz", "#CuisineMaison"],
    cta: "Le filet à découvrir → lien en bio",
    ...
    imageUrl: "https://cdn.shopify.com/s/files/1/0489/8684/9433/products/3760164640630.jpg?v=1748431790",
    published: false
  },
  {
    ...
    caption: "Les bateaux rentrent, chargés de promesses. Au port de Saint-Jean-de-Luz, chaque retour de pêche est un rituel. Les mains s’activent, les caisses se remplissent — et c’est de là que viennent nos Sardines à l’huile d’olive bio. ⛵🐟\n\nHommage à ces hommes et femmes de la mer qui perpétuent la tradition, marée après marée. Du port au bocal, le chemin est court.\n\n🛒 jeandeluz.com/products/sardines-a-lhuile-dolive-bio",
    hashtags: ["#SaintJeandeLuz", "#PaysBasque", "#Pêcheurs", "#PortDePêche", "#Tradition", "#ConserverieJeandeLuz"],
    cta: "Nos sardines du port → lien en bio",
    ...
    imageUrl: "https://cdn.shopify.com/s/files/1/0489/8684/9433/products/jean_de_luz_sardines_huile.jpg?v=1748431811",
    published: false
  },
  {
    ...
    caption: "2 minutes chrono. Ouvrez un Filet de Thon Germon à l’huile d’olive et au piment d’Espelette AOP bio, émiettez, un filet de citron vert, quelques herbes fraîches. Le tartare le plus simple et le plus addictif de votre été. 🔥🍋\n\nParfait sur un toast grillé ou dans une feuille de laitue croquante. Le piment est déjà dedans — pas d’excuse, c’est ultra rapide.\n\n🛒 jeandeluz.com/products/filet-de-thon-germon-a-lhuile-dolive-et-au-piment-despelette-aop",
    hashtags: ["#RecetteExpress", "#Tartare", "#PimentEspelette", "#ThonGermon", "#ConserverieJeandeLuz", "#PaysBasque"],
    cta: "Le filet Espelette → lien en bio",
    ...
    imageUrl: "https://cdn.shopify.com/s/files/1/0489/8684/9433/products/3760164640647.jpg?v=1748431789",
    published: false
  },
  {
    ...
    caption: "Certaines recettes traversent le temps sans prendre une ride. Nos Sardines à l’huile d’olive et au citron bio sont préparées comme autrefois : à la main, rangées une à une dans leur bocal. Le citron apporte cette fraîcheur vive qui réveille tout. 🐟🍋\n\nLe geste est le même depuis toujours. Un savoir-faire qui refuse de disparaître.\n\n🛒 jeandeluz.com/products/sardines-a-lhuile-dolive-bio-et-au-citron-bio",
    hashtags: ["#Sardines", "#ConserverieJeandeLuz", "#Vintage", "#SavoirFaire", "#Artisanat", "#JeanDeLuz"],
    cta: "Sardines citron → lien en bio",
    ...
    imageUrl: "https://cdn.shopify.com/s/files/1/0489/8684/9433/products/jean_de_luz_sardines_citron.jpg?v=1748431794",
    published: false
  },
  {
    ...
    caption: "Le panier est prêt, la côte nous attend. Une baguette croustillante, notre Coffret Pêche à Saint Jean glissé dans le sac et les pieds dans l’herbe face à l’Atlantique. Ici, on ne déjeune pas : on contemple. 🌊🧺\n\nLe vent porte le sel, le soleil chauffe les épaules. On ouvre un bocal, on tartine sur la croûte dorée. Le Pays Basque se savoure comme ça : simplement, généreusement.\n\nBon week-end à tous. 🌿\n\n🛒 jeandeluz.com/products/coffret-decouverte-jean-de-luz",
    hashtags: ["#ConserverieJeandeLuz", "#PiqueniqueBasque", "#SaintJeandeLuz", "#PaysBasque", "#SlowFood", "#VieSimple"],
    cta: "Le coffret pique-nique → lien en bio",
    ...
    imageUrl: "https://cdn.shopify.com/s/files/1/0489/8684/9433/products/20211007_145241.jpg?v=1748431782",
    published: false
  },
  {
    ...
    imageUrl: "https://cdn.shopify.com/s/files/1/0489/8684/9433/products/fdb_sardine_citron_beurre_01.jpg?v=1748431794",
    published: false
  },
  {
    ...
    caption: "Dimanche matin, on prend le temps. Voici le brunch qui sent bon le Pays Basque 🍞☀️\n\nNotre Assortiment 3 terrines — Terrine de thon aux tomates, Terrine de sardines à l’ail, Terrine de maquereaux aux oignons — plus une touche de Brandade de morue, et le brunch est servi.\n\nToastez, tartinez, savourez. Le dimanche parfait tient dans quelques bocaux bien choisis. 🥂\n\n🛒 jeandeluz.com/products/assortiment-3-terrines",
    hashtags: ["#ConserverieJeandeLuz", "#BrunchTime", "#RecetteFacile", "#Tartines", "#SaintJeandeLuz", "#GourmandiseBasque"],
    cta: "L’assortiment terrines → lien en bio",
    ...
    imageUrl: "https://cdn.shopify.com/s/files/1/0489/8684/9433/products/fdb_la_basquaise_ambiances_030_s.jpg?v=1748431786",
    imageUrls: [
      "https://cdn.shopify.com/s/files/1/0489/8684/9433/products/fdb_la_basquaise_ambiances_030_s.jpg?v=1748431786",
      "https://cdn.shopify.com/s/files/1/0489/8684/9433/products/3760164640180.jpg?v=1748431816",
      "https://cdn.shopify.com/s/files/1/0489/8684/9433/products/3760164640265.jpg?v=1748431812",
      "https://cdn.shopify.com/s/files/1/0489/8684/9433/files/fdb_brandade_380_m.jpg?v=1748431802"
    ],
    published: false
  },
  {
    ...
    caption: "Mai s’achève en beauté. Pique-niques sur la côte, coulisses de l’atelier, tartines du dimanche… ce mois était riche en partages. Merci d’être là. 🙏🌅\n\nEt pour bien lancer l’été, notre Coffret cadeau ‘Itsasoa’ — la mer en basque — vous attend. Tout le meilleur du large réuni dans un seul coffret. Vous allez voir, juin sera savoureux. 👀\n\n🛒 jeandeluz.com/products/coffret-cadeau-itsasoa",
    hashtags: ["#ConserverieJeandeLuz", "#JeanDeLuz", "#PaysBasque", "#TeaserJuin", "#Nouveauté", "#SaintJeandeLuz"],
    cta: "Coffret Itsasoa → lien en bio",
    ...
    imageUrl: "https://cdn.shopify.com/s/files/1/0489/8684/9433/files/53acd3e3-a83d-4741-9c56-b0b252b28a5a.jpg?v=1748431771",
    published: false
  },
